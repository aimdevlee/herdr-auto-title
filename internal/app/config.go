...
type Config struct {
	...
	MaxLength int
	// Scroll slides a name too wide for MaxLength — a tab's title, a pane's
	// label — across the width it has instead of cutting it.
	Scroll bool
	// ScrollStep is how far a sliding name moves per poll, in columns. It is
